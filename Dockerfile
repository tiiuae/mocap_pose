...
FROM --platform=${BUILDPLATFORM:-linux/amd64} ghcr.io/tiiuae/fog-ros-sdk:experiment_sdk_without_extraction-${TARGETARCH:-amd64} AS builder
...
FROM ghcr.io/tiiuae/fog-ros-baseimage:experiment_sdk_without_extraction
