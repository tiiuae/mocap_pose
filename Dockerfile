...
ENTRYPOINT exec ros-with-env ros2 launch mocap_pose mocap_pose.launch address:=$INDOOR_SERVER_IP_ADDRESS lat:=$INDOOR_ORIGO_LATITUDE lon:=$INDOOR_ORIGO_LONGITUDE alt:=$INDOOR_ORIGO_ALTITUDE
