...
FROM --platform=${BUILDPLATFORM:-linux/amd64} ghcr.io/tiiuae/fog-ros-sdk:px4-msgs-7.0.0-${TARGETARCH:-amd64} AS builder
...
FROM ghcr.io/tiiuae/fog-ros-baseimage:px4-msgs-7.0.0
